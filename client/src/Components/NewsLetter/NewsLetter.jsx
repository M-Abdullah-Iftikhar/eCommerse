...
const NewsLetter = () => {
  return (
    <div class=" mt-32  sm:mt-56 lg:px-8">
    <div
        class="relative isolate overflow-hidden bg-gray-900 px-6 py-24 shadow-2xl   sm:px-24 xl:py-32">
       
        <h2 class="mx-auto max-w-2xl text-center text-3xl font-bold tracking-tight text-white sm:text-4xl">Get Exlusive Offers On Your Email
        </h2>

        <p class="mx-auto mt-2 max-w-xl text-center text-lg leading-8 text-gray-300">
           Subscribe TO Our News Letter For Updated
        </p>

        <form class="mx-auto mt-10 flex flex-col gap-4 min-[350px]:gap-0  min-[350px]:flex-row max-w-md gap-x-4">
            ...
            <button type="submit" class="flex-none rounded-md bg-white px-3.5 py-2.5 text-sm font-semibold text-gray-900 shadow-sm hover:bg-gray-100 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white">Subscibe</button>
        </form>
